...
<body style="background-color: #d9f6d9">
<%
...
<table width="700px" align="center" border="0px">
    <tr><td><br/><%=r.getUID()%>的答题记录</td></tr>
    <tr><td>1.<%=questionDao.getQuestion(r.getQID1()).getQuestion()%></td></tr>
    <%System.out.println("1:"+questionDao.getQuestion(r.getQID1()).getQuestion());%>
    ...
    <%System.out.println("2:"+questionDao.getQuestion(r.getQID2()).getQuestion());%>
    ...
    <%System.out.println("3:"+questionDao.getQuestion(r.getQID3()).getQuestion());%>
    ...
    <%System.out.println("4:"+questionDao.getQuestion(r.getQID4()).getQuestion());%>
    ...
    <%System.out.println("5:"+questionDao.getQuestion(r.getQID5()).getQuestion());%>
